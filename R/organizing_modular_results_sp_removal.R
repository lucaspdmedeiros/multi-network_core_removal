...
# general core
output_gen = read.table("output/data/core_species_removal/modularity/OUT_MOD_gen_core_sp.txt", 
                        header = TRUE)
...
write.csv(mod_gen_random, 
          file = "output/data/core_species_removal/modularity/modularity_gen_core_sp_random.csv",
          row.names = FALSE)

# pollination core
output_pol = read.table("output/data/core_species_removal/modularity/OUT_MOD_pol_core_sp.txt", 
                        header = TRUE)
...
write.csv(mod_pol_random, 
          file = "output/data/core_species_removal/modularity/modularity_pol_core_sp_random.csv",
          row.names = FALSE)

# ant core
output_ant = read.table("output/data/core_species_removal/modularity/OUT_MOD_ant_core_sp.txt", 
                        header = TRUE)
...
write.csv(mod_ant_random, 
          file = "output/data/core_species_removal/modularity/modularity_ant_core_sp_random.csv",
          row.names = FALSE)

# dispersal core
output_disp = read.table("output/data/core_species_removal/modularity/OUT_MOD_disp_core_sp.txt", 
                        header = TRUE)
...
write.csv(mod_disp_random, 
          file = "output/data/core_species_removal/modularity/modularity_disp_core_sp_random.csv",
          row.names = FALSE)
...
write.csv(p_values_mod, 
          file = "output/data/core_species_removal/modularity/modularity_core_sp_removal_p_values.csv",
          row.names = FALSE)
